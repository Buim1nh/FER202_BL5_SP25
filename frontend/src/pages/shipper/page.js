...
const getOrderConfirmation = (orderId) => {
  ...
  return confirmation ? confirmation.confirmed : undefined;
};
          ...
          {!showDetail.show && (
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="overflow-x-auto">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {paginateData(filteredOrders).map((order) => (
                      <tr key={order.order_id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          {order.customer_confirmation === true && (
                            <span className="text-green-600 font-semibold">
                              Đã xác nhận
                            </span>
                          )}
                          {order.customer_confirmation === false && (
                            <span className="text-red-500 font-semibold">
                              Chưa xác nhận
                            </span>
                          )}
                          {order.customer_confirmation === undefined && (
                ...
                {(activeTab === "allOrders" ? orders : myOrders).length ===
                  0 && (
              ...
              <div className="mt-4 flex items-center justify-end gap-2">
                ...
                {Array.from(
                  {
                    length: getTotalPages(
                      activeTab === "allOrders" ? orders : myOrders
                    ),
                  },
                  (_, i) => i + 1
                ).map((page) => (
                ...
                <button
                  ...
                  disabled={
                    currentPage ===
                    getTotalPages(activeTab === "allOrders" ? orders : myOrders)
                  }
                  className="px-3 py-1 border border-gray-300 rounded-md text-sm text-gray-500 hover:bg-gray-50 disabled:opacity-50"
                >
                  Tiếp
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto border border-gray-200">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-800">
                    {new Date(showDetail.data.order_date).toLocaleString(
                      "vi-VN"
                    )}
                  </span>
                </div>
